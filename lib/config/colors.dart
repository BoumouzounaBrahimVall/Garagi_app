...
class AppColors {
  ...
  static const colorRed = Color(0xFFF05237);
...
class AvatarsBgColors {
  static const colorBlue = Color(0xFF8AC5D9);
  static const colorYellow = Color(0xFFFDCC49);
  static const colorPink = Color(0xFFDF6E8C);
  static const colorGreen = Color(0xFF99CEB2);
  static const colorOrange = Color(0xFFED6E45);
  static const colorGray = Color(0xFFDADADA);
}
